...
export const useStore = defineStore({
  ...
  state: () => ({
    ...
    boxOptions: [
      ...
      { id: 5, modalTitle: 'How many people are still in section 3?', contentTitle: '# of Persons in 3rd Section', content: '' },
      { id: 6, modalTitle: 'How many have already crossed the finish line?', contentTitle: 'Runners at the Finish:', content: 'None yet' },
      { id: 7, modalTitle: 'How many are DNF?', contentTitle: 'Runners DNF', content: 'None yet' },
      { id: 8, modalTitle: 'How many are still at the start?', contentTitle: 'Runners at the Start:', content: 'None' },
      { id: 9, modalTitle: 'How many are supposed to start?', contentTitle: 'Runners altogether:', content: 'None' },
      ],
  }),
  actions: {
